...
`ssh -p 57760 ctf-player@atlas.picoctf.net`
...
```
## Notas adicionales
- en este reto la vdd tuve que adivinar poniendo numeros, empecé por el 500 que era el medio del rango y de ahí segui haciendo lo mismo
## Referencias
